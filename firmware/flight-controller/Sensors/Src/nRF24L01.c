...
void NRF24_InitPins()
{
  clock_enable_AHB1(GPIOA_peripheral);
    ...
    GPIOA_CONFIG( P0, GPIO_OUTPUT, GPIO_PUSHPULL, GPIO_FAST, GPIO_NOPULL, 0, 0, 0); //CSN_NRF24L01
    GPIOA_CONFIG( P15, GPIO_OUTPUT, GPIO_PUSHPULL, GPIO_FAST, GPIO_NOPULL, 0, 0, 0); //CE_NRF24L01
